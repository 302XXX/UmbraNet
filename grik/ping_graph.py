"""
UmbraNet — grik: виджет графика пинга.

Вынесен из главного меню («Маршрутизация») в standalone-модуль grik/
по итогам диагностики лагов: таймер обновления графиков мешал
живому resize окна. Виджет и его отрисовка не изменились — 1:1.
